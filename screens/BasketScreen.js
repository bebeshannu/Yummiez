    ...
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-1 bg-gray-100 ">
        <View className="p-5 border-b border-[#00CCBB] bg-white shadow-xs">
            <View>
                <Text className="text-lg pt-8 font-bold text-center">Basket</Text>
            ...
            >
                <XCircleIcon color="#00CCBB" height={40} width={50}/>
            </TouchableOpacity>
        ...
        <View className="flex-row justify-between">
            ...
            <Text className="text-gray-400">Rs.{50.99}</Text>
        </View>
        <View className="flex-row justify-between">
            <Text >Order Total</Text>
            <Text className="font-extrabold">Rs.{basketTotal+50.99}</Text>
        </View>
